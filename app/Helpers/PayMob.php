...
class PayMob
{
    ...
    public function __construct()
    {
        $this->token = '';
        $this->auth = '';
        $this->api_key = '';
    }
     ...
     * @return array
     */
    public function makeOrderPaymob( $merchant_id, $amount_cents, $merchant_order_id,$items,$email,$name,$phone)
    {
        // Request body
        $json = [
            ...
            'shipping_data' => (object) [
                ...
                'email' => $email,
                'phone_number' => $phone ? $phone : 'no-phone-found',
