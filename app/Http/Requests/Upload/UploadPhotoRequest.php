...
class UploadPhotoRequest extends FormRequest
{
    ...
    public function all($keys = NULL){
        ...
        foreach ($features as $key => $value) {
            if($value->service->name=='upload photo'){
                $request['upload_photo_feature'] = 'ture' ; 
    ...
    {
        return [
            'upload_photo_feature.required' => 'this feature is not on this package' , 
