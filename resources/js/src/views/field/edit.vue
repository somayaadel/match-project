        ...
        <div class="vx-col w-full md:w-full sm:w-full">
          <vx-card>
            <div class="row px-3">
              ...
              <h1 class="my-3 text-title-grey">Edit field</h1>
            </div>
...
computed: {
  ...
  methods: {
    getFieldData(){
      axios.get('/api/field/'+ this.$route.params.id).then(res=>{
    ...
    submitData(){
      ...
      this.$validator.validateAll().then((res) => {
          axios.put('/api/field/'+this.$route.params.id , this.fieldData).then(res=>{
