...

        {
            ...
            children: [
...

                {
                    ...
                    name: 'facebookLogin',
                    component: () =>
                        import ('./views/facebookLogin.vue'),
                    meta: {
                        rule: 'staffOrAdmin',
                    }
                },

                {
                    ...
                    name: 'countryList',
                    component: () =>
                        import ('./views/configration/country/list.vue'),
                    meta: {
                        rule: 'staffOrAdmin',
                    }
                },
                {
                    ...
                    name: 'addCountry',
                    component: () =>
                        import ('./views/configration/country/add.vue'),
                    meta: {
                        rule: 'staffOrAdmin',
                    }
                },
                {
                    ...
                    name: 'editCountry',
                    component: () =>
                        import ('./views/configration/country/edit.vue'),
                    meta: {
                        rule: 'staffOrAdmin',
                    }
                },
...

                {
                    ...
                    name: 'cityList',
                    component: () =>
                        import ('./views/configration/city/list.vue'),
                    meta: {
                        rule: 'staffOrAdmin',
                    }
                },
                {
                    ...
                    name: 'addCity',
                    component: () =>
                        import ('./views/configration/city/add.vue'),
                    meta: {
                        rule: 'staffOrAdmin',
                    }
                },
                {
                    ...
                    name: 'editCity',
                    component: () =>
                        import ('./views/configration/city/edit.vue'),
                    meta: {
                        rule: 'staffOrAdmin',
                    }
                },

                {
                    ...
                    name: 'jobList',
                    component: () =>
                        import ('./views/configration/job/list.vue'),
                    meta: {
                        rule: 'staffOrAdmin',
                    }
                },
                {
                    ...
                    name: 'addJob',
                    component: () =>
                        import ('./views/configration/job/add.vue'),
                    meta: {
                        rule: 'staffOrAdmin',
                    }
                },
                {
                    ...
                    name: 'editJob',
                    component: () =>
                        import ('./views/configration/job/edit.vue'),
                    meta: {
                        rule: 'staffOrAdmin',
                    }
                },
                ...
                },
                {
                    ...
                    name: 'addApplication',
                    component: () =>
                        import ('./views/application/add.vue'),
                    meta: {
                        rule: 'staffOrAdmin',
                    }
                },
                {
                    ...
                    component: () =>
                        import ('./views/application/edit.vue'),
                    meta: {
                        rule: 'staffOrAdmin',
                    }
                },
...

                {
                    ...
                    name: 'categoryList',
                    component: () =>
                        import ('./views/categories/list.vue'),
                    meta: {
                        rule: 'staffOrAdmin',
                    }
                },
                {
                    ...
                    name: 'addCategory',
                    component: () =>
                        import ('./views/categories/add.vue'),
                    meta: {
                        rule: 'staffOrAdmin',
                    }
                },
                {
                    ...
                    name: 'editCategory',
                    component: () =>
                        import ('./views/categories/edit.vue'),
                    meta: {
                        rule: 'staffOrAdmin',
                    }
                },
                {
                    ...
                    name: 'importCateg',
                    component: () =>
                        import ('./views/categories/import.vue'),
                    meta: {
                        rule: 'staffOrAdmin',
                    }
                },
                {
                    ...
                    component: () =>
                        import ('./views/categoryType/edit.vue'),
                    meta: {
                        rule: 'staffOrAdmin',
                    }
                },
                {
                    ...
                    component: () =>
                        import ('./views/categoryType/list.vue'),
                    meta: {
                        rule: 'staffOrAdmin',
                    }
                },
                {
                    ...
                    component: () =>
                        import ('./views/categoryType/add.vue'),
                    meta: {
                        rule: 'staffOrAdmin',
                    }
                },
                ...
                },
                {
                    ...
                    component: () =>
                        import ('./views/applicationSettings/show.vue'),
                    meta: {
                        rule: 'staffOrAdmin',
                    }
                },

                {
                    ...
                    name: 'emailList',
                    component: () =>
                        import ('./views/email/emailList.vue'),
                    meta: {
                        rule: 'staffOrAdmin',
                    }
                },

                {
                    ...
                    name: 'sendEmail',
                    component: () =>
                        import ('./views/email/sendEmail.vue'),
                    meta: {
                        rule: 'staffOrAdmin',
                    }
                },
...

                {
                    ...
                    component: () =>
                        import ('./views/contact_message/list.vue'),
                    meta: {
                        rule: 'staffOrAdmin',
                    }
                },

                {
                    ...
                    name: 'profileFields',
                    component: () =>
                        import ('./views/field/profileFields.vue'),
                    meta: {
                        rule: 'staffOrAdmin',
                    }
                },
                ...
                },
                {
                    ...
                    name: 'featureList',
                    component: () =>
                        import ('./views/configration/feature/list.vue'),
                    meta: {
                        rule: 'staffOrAdmin',
                    }
                },
                {
                    ...
                    name: 'addfeature',
                    component: () =>
                        import ('./views/configration/feature/add.vue'),
                    meta: {
                        rule: 'staffOrAdmin',
                    }
                },
                {
                    ...
                    name: 'editfeature',
                    component: () =>
                        import ('./views/configration/feature/edit.vue'),
                    meta: {
                        rule: 'staffOrAdmin',
                    }
                },
                {
                    ...
                    component: () =>
                        import ('./views/configration/googleAnalytics/show.vue'),
                    meta: {
                        rule: 'staffOrAdmin',
                    }
                },
...
router.beforeEach((to, from, next) => {
    ...
    const role = localStorage.getItem("userInfo") ?
        JSON.parse(localStorage.getItem("userInfo")).role.name :
        "";

    if (to.path == "/pages/login" || to.name == 'page-reset-password') {
        return next();
    }
